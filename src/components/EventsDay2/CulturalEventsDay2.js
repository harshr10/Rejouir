...
import { CulturalEventsDay2 } from '../../data';
...
const Culturalevents = () => {
  ...
  const { title, subtitle, list } = CulturalEventsDay2;
  return (
    <section className='my-[70px] xl:my-[50px]'>
      <div className='container mx-auto'>
        ...
        <div className='text-center'>
          ...
          <p
            className='lead max-w-[584px] mx-auto mb-16m -m-5 xl:mb-24 font-bold text-xl text-red-600 dark:text-white'
            data-aos='fade-down'
            data-aos-delay='200'
          >
            {subtitle}
