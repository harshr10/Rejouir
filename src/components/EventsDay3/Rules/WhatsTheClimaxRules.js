import climax from '../Posters/WHATS THE CLIMAX.jpg';
const WhatsTheClimaxRules = () => {
    return (
        <section>
            <div>
                <section
                    ...
                    <div className='container mx-auto'>
                        <div className='bg-gradient-to-l from-red-200 to-indigo-200 rounded-[50px] min-h-[240px] px-12 py-12 flex flex-col text-center xl:flex-row xl:items-center xl:text-left  xl:gap-x-[60px] xl:pb-0'>
                            <div className='flex-1 xl:pr-12'>
                                ...
                                <li className="py-3 text-left   font-medium">1. Do not exceed more than 300 words</li>
                                    <li className="py-3 text-left   font-medium">2. Complete within the given time</li>
                                    <li className="py-3 text-left   font-medium">3. Mobile phone and smart watches not allowed</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='bg-gradient-to-l from-yellow-200 to-lime-200 rounded-[50px] min-h-[240px] px-12 pb-12 flex flex-col text-center xl:flex-row xl:items-center xl:text-left  xl:gap-x-[60px] xl:pb-0'>
                            <div className='flex-1 xl:pr-12'>
                                <ul className="list-outside py-3" data-aos='fade-left'>
                                    ...
                                    <li className="py-3 text-left font-medium">1. Arunachalam-9360518135</li>
                                    <li className="py-3 text-left font-medium">2. Yasmin-9344730801</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                </section>
                <img className='pt-10 md:mx-auto md:max-h-[60rem]' src={climax} style={{width:'70%' , height:'70%'}}/>
            </div>
        </section>
    );
};

export default WhatsTheClimaxRules;