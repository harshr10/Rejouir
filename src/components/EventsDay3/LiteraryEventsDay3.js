...
import { LiteraryEventsDay3 } from '../../data';
...
const Literaryevents = () => {
  ...
  const { title, subtitle, list } = LiteraryEventsDay3;
  return (
    <section className='my-[70px] xl:my-[70px]'>
      <div className='container mx-auto'>
        ...
        <div className='text-center'>
          <h1
            className='mb-6 xl:mb-12 font-bold text-3xl text-indigo-600 dark:text-white'
            data-aos='fade-down'
            data-aos-delay='100'
          >
            {title}
          ...
          <p
            className='lead max-w-[584px] mx-auto mb-16 xl:mb-24 -m-5 text-red-600 font-bold text-xl dark:text-white'
            data-aos='fade-down'
            data-aos-delay='200'
          >
            {subtitle}
        ...
        {/* feature list */}
        <div className='grid grid-cols-2 gap-[50px] xl:grid-cols-2'>
