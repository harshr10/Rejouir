...
import { EsportsEventsDay3 } from '../../data';
...
const Esportsevents = () => {
  ...
  const { title, subtitle, list } = EsportsEventsDay3;
  return (
    <section className='my-[70px] xl:my-[70px]'>
      <div className='container mx-auto'>
        ...
        <div className='text-center'>
          ...
          <p
            className='lead max-w-[584px] mx-auto mb-16 xl:mb-24 -m-5 font-bold text-xl text-red-600 dark:text-white'
            data-aos='fade-down'
            data-aos-delay='200'
          >
            {subtitle}
